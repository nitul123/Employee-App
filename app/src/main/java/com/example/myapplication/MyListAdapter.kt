...
class MyListAdapter(private val context: Activity, private val id: Array<String>, private val name: Array<String>, private val sallary: Array<String>, private val age: Array<String>)
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        emailText.text = "Sallary : ${sallary[position]}"
        return rowView
    }
}